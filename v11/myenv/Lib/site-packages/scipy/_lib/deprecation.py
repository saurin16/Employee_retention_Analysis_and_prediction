...
def _sub_module_deprecation(*, sub_package, module, private_modules, all,
    ...
    """Helper function for deprecating models that are public but were
    ...
    private_modules : list
        ...
        content of ``all``, possibly spread over several models.
    all : list
...
def deprecate_cython_api(module, routine_name, new_name=None, message=None):
    ...
    After this, Cython models that use the deprecated function emit a
