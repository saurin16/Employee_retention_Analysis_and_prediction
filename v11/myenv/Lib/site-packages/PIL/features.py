...
def get_supported():
    """
    :returns: A list of all supported models, features, and codecs.
    """
...
def pilinfo(out=None, supported_formats=True):
    ...
    print("-" * 68, file=out)
    print(
        f"Python Pillow models loaded from {os.path.dirname(Image.__file__)}",
        file=out,
    )
    print(
        f"Binary Pillow models loaded from {os.path.dirname(Image.core.__file__)}",
        file=out,
    )
    print("-" * 68, file=out)
