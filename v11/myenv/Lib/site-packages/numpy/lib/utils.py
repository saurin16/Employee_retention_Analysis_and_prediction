...
def get_include():
    ...
    Extension models that need to compile against NumPy should use this
...
def info(object=None, maxwidth=76, output=None, toplevel='numpy'):
    ...
    object : object or str, optional
        ...
        a string, available models are searched for matching objects.
...
def lookfor(what, module=None, import_modules=True, regenerate=False,
    ...
    import_modules : bool, optional
        Whether to import sub-models in packages. Default is True.
...
def _lookfor_generate_cache(module, import_modules, regenerate):
    ...
    import_modules : bool
        Whether to import sub-models in packages.
    regenerate : bool
