...
def get_path_from_frame(frame, parent_path=None):
    ...
    try:
        ...
        # sys.models['__main__'] might be something else, like easy_install(1).
...
class Configuration:
    ...
    def _get_configuration_from_setup_py(self, setup_py,
                                         ...
                                         parent_name,
                                         caller_level = 1):
        # In case setup_py imports local models:
    ...
    def add_include_dirs(self,*paths):
        ...
        list. This list will be visible to all extension models of the
        current package.
        """
    ...
    def paths(self,*paths,**kws):
        ...
        of sources for extension models and libraries and scripts and allows
