...
2) To compile fortran files and build extension models:
...
def run_main(comline_list):
    ...
    information on generated models and their dependencies on source
    files.

    You cannot build extension models with this function, that is,
