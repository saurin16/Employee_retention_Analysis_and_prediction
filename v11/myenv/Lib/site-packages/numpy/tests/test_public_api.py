...
def test_import_lazy_import(name):
    """Make sure we can actually use the models we lazy load.
    ...
    We also test for the presence of the lazily imported models in dir
...
#
# The PRIVATE_BUT_PRESENT_MODULES list contains models that look public (lack
# of underscores) but should not be used.  For many of those models the
...
# suppressing warnings from deprecated models
...
def test_all_modules_are_expected_2():
    ...
    if unexpected_members:
        raise AssertionError("Found unexpected object(s) that look like "
                             "models: {}".format(unexpected_members))
