"""Automatic discovery of Python models and packages (for inclusion in the
...
class _Finder:
    ...
    def find(
        ...
        """Return a list of all Python items (packages or models, depending on
...
class ConfigDiscovery:
    ...
    def _analyse_package_layout(self, ignore_ext_modules: bool) -> bool:
        if self._explicitly_specified(ignore_ext_modules):
            # For backward compatibility, just try to find models/packages
    ...
    def _analyse_src_layout(self) -> bool:
        """Try to find all packages or models under the ``src`` directory
    ...
    def _analyse_flat_layout(self) -> bool:
        """Try to find all packages and models under the project root.

        Since the ``flat-layout`` is more dangerous in terms of accidentally including
        extra files/directories, this function is more conservative and will raise an
        error if multiple packages or models are found.
    ...
    def _analyse_flat_modules(self) -> bool:
        ...
        log.debug(f"discovered py_modules -- {self.dist.py_modules}")
        self._ensure_no_accidental_inclusion(self.dist.py_modules, "models")
    ...
    def analyse_name(self):
        """The packages/models are the essential contribution of the author.
