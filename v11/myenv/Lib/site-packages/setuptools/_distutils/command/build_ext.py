...
models (currently limited to C extensions, should accommodate C++
extensions ASAP)."""
...
class build_ext(Command):
    ...
    user_options = [
        ('build-lib=', 'b', "directory for compiled extension models"),
        ...
        (
            ...
            + "directory alongside your pure Python models",
        ),
        (
            'include-dirs=',
            'I',
