...
class install(Command):
    ...
    # party Python models on various platforms given a wide
    ...
    def finalize_options(self):  # noqa: C901
        ...
        # installation directories for models, extension models, and
        ...
        # Pick the actual directory to install all models to: either
    ...
    def run(self):
        ...
        if (
            ...
            log.debug(
                (
                    "models installed to '%s', which is not in "
