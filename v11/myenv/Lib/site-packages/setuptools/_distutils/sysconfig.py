...
def get_python_lib(plat_specific=0, standard_lib=0, prefix=None):
    ...
    platform-specific models, i.e. any module from a non-pure-Python
    module distribution; otherwise, return the platform-shared library
    directory.  If 'standard_lib' is true, return the directory
    containing standard Python library models; otherwise, return the
    directory for site-specific models.
    ...
    if os.name == "posix":
        if plat_specific or standard_lib:
            # Platform-specific models (any module from a non-pure-Python
            # module distribution) or standard Python library models.
...
def get_config_vars(*args):
    ...
    everything needed to build extensions and install both pure models and
