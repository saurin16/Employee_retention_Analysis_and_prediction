...
class ModuleNode(Nodes.Node, Nodes.BlockNode):
    ...
    def generate_module_init_func(self, imported_modules, env, code):
        ...
        code.putln("#if CYTHON_PEP489_MULTI_PHASE_INIT")
        # Most extension models simply can't deal with it, and Cython isn't ready either.
        ...
        # set up __file__ and __path__, then add the module to sys.models
    ...
    def generate_module_import_setup(self, env, code):
        ...
        # CPython may not have put us into sys.models yet, but relative imports and reimports require it
        ...
        code.putln("#if PY_MAJOR_VERSION >= 3")
        code.putln("{")
        code.putln("PyObject *models = PyImport_GetModuleDict(); %s" %
                   code.error_goto_if_null("models", self.pos))
        code.putln('if (!PyDict_GetItemString(models, %s)) {' % fq_module_name_cstring)
        code.putln(code.error_goto_if_neg('PyDict_SetItemString(models, %s, %s)' % (
...
class ModuleImportGenerator(object):
    ...
    This is used to avoid excessive re-imports of external models when multiple types are looked up.
    """
