...
##############################
# Support for a few standard library models that Cython understands (currently typing and dataclasses)
##############################
...
def get_known_standard_library_entry(qualified_name):
    ...
    if len(rest) > 1:  # for now, we don't know how to deal with any nested models
        return None
