...
def cythonize(module_list, exclude=None, nthreads=0, aliases=None, quiet=False, force=None, language=None,
    ...
    """
    Compile a set of source models into C/C++ files and return a list of distutils
    ...
    :param force: Forces the recompilation of the Cython models, even if the timestamps
                  don't indicate that a recompilation is necessary.

    :param language: To globally enable C++ mode, you can pass ``language='c++'``. Otherwise, this
                     will be determined at a per-file level based on compiler directives.  This
                     affects only models found based on file names.  Extension instances passed
